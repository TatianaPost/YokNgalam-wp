...
$ale_custfont = ale_get_option ('custfont');
...
<?php
    ...
    if(ale_get_option('custfontex')){ $custfontex = ":".ale_get_option('custfontex'); } else {$custfontex = "";}
    ...
    if(ale_get_option('custfont')){ echo "<link href='/".ale_get_option('custfont')."/stylesheet.css' rel='stylesheet' type='text/css'>"; }
?>
<style type='text/css'>
    body {
        <?php
    ...
    /*Custom Font*/
     {
    <?php if($ale_custfont){ $custfontname =  str_replace ('+',' ',$ale_custfont); echo "font-family:".$custfontname.";"; } ?>
    }
