...
function ale_enqueue_styles() {
	...
	wp_register_style( 'aletheme_fontawesome_css', THEME_URL . '/css/font-awesome.min.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_enqueue_style('aletheme_general_css');
    wp_enqueue_style('aletheme_fontawesome_css');
}
