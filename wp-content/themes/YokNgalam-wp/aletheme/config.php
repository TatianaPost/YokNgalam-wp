...
function aletheme_get_options() {
    ...
    $custfont = array_merge(ale_get_safe_webfonts(), ale_get_custom_webfonts());
	...
	$options[] = array( "name" => "Select the Custom Font",
	                    "desc" => "The default Font is - ChunkFive",
	                    "id" => "ale_custfont",
	                    "std" => "ChunkFive",
	                    "type" => "select",
	                    "options" => $custfont);

	$options[] = array( "name" => "Select the Custom Font (Extended)",
